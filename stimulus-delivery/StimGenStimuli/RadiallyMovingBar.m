...
%%%%%%%%%%%%%%%%%%%%%%%%% GET STIMULUS SHADE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Note  the shade is a fraction of
    % 100 to be multiplied by the range in luminance values ( so for example if
    % white = 100 cd/m^2, black = 0 then gray values of 128 mean gray = 50
    % cd/m^2 so we call Gamma correct to perform this operation
    ScreenShade = GammaCorrect(trials(trial).Screen_Luminance/100*...
                                (whiteLum + blackLum));
    BarShade = GammaCorrect(trials(trial).Bar_Luminance/100*...
                                (whiteLum + blackLum));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% DRAW BAR TEXTURE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%         
        ...
        % speed
        runtime = vbl + 2*radius/(speed/degPerPix);
